...
google_analytics:
  - G-E5VVCWR37F # New GA4 property      ,  UA is about to be deprecated on Jul 1, 2023,
...
## 版权
版权知识无论是对于原创音乐人，还是唱片公司都非常的重要，我们经常会看到©，℗，®，™，℠标识。

相较于®，™跟℠是没有注册的商标，分别代表Trademark跟Service Mark，主要的差别是，前者挂在产品商标，后者挂在服务商标。因为不用登记，所以基本上任何设计的商标都可以使用™跟℠。

©跟℗分别是代表「著作权」(Copyright)跟「录音著作权」(Sound-recording Copyright)。文字的东西基本上都是©；音乐的话，填歌词、谱歌曲算是©，但是真的把曲子唱出来、演奏出来，并且录音之后，就是℗了。


如何使用 © ？

A.开头使用©符号，Copyright或Copr.简写字样；

B.跟随作品首次发表年份及最新使用年份(可二选一)；

C.跟随版权所有者名称；

D.跟随版权所有字样All rights reserved（可省略）。
